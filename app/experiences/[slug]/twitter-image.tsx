/**
 * Twitter-card image for `/experiences/<slug>`.
 *
 * Re-exports the OG image so both `og:image` and `twitter:image` meta
 * tags point at the same branded per-experience card. Keeping them in
 * sync matters because Twitter's `twitter:image` takes precedence over
