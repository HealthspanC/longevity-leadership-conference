...
function ExperienceCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row flex-1 lg:min-h-[464px] overflow-hidden rounded-b-[28px]">
        {/* Media — 5:4 stacked mobile, 46% of card on desktop */}
        <div className="relative lg:w-[46%] aspect-[5/4] lg:aspect-auto lg:min-h-[464px] bg-purple-wash shrink-0 overflow-hidden">
          <Image
